...
import 'package:fed_tms/core/services/api_client.dart';
import 'package:fed_tms/features/messaging/data/models/conversation.dart';
import 'package:fed_tms/features/messaging/data/models/message.dart';
...
class MessageService {
  ...
  Future<List<Conversation>> getConversations({
    ...
    final response =
        await _apiClient.get('/conversations', queryParameters: queryParams);
