// Marketeer v0.1.0 - MarkOS Environment Coordinator
//  Marketeer:
//  Places a marker in client root environment directory before they enter the system.
//    Location: <root.env>/.mark
//    in_every: true 
//    location: client 
//    system: env
...
// System Models
const MARKETEER_MRKR: &str = "http://192.168.12.000:11434";
const CODRIVER_MRKR: &str = "http://192.168.12.000:11434";
const OPENHWY_MRKR: &str = "http://192.168.12.000:11434";
const TRAKAPAY_MRKR: &str = "http://192.168.12.000:11434";
const KEEPERDB_MRKR: &str = "http://192.168.12.000:"
...
// System Schemas
const MRKS_FILE: &str = "$HOME/.mark/marks/*MARK*/<config>.mrks";
const MRKR_FILE: &str = "$HOME/.mark/markers/*MARK*/<logic>.mrkr";
const CHAT_FILE: &str = "$HOME/.mark/chats/*MARK*/<chat>.md";
const USER_FILE: &str = "$HOME/.mark/profiles/*MARK*/<user>.prf";

// Database Schemas
const MARKETEER_ROUTER: &str = "/var/data/<Agent>: MarketeerRR"
const KEEPER_HANDLER: &str = "/var/data/<Agent>: KeeperHR>";
const CODRIVER_MANAGER: &str = "/var/data/<Agent>: CodriverMR>";
