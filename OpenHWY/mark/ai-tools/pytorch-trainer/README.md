...
mkdir -p /root/WORKSPACE/ai/setups/framework/core
mkdir -p /root/WORKSPACE/ai/setups/framework/src

# Copy all Python files to their locations:
# - main.py → /root/WORKSPACE/ai/setups/framework/
# - core/*.py → /root/WORKSPACE/ai/setups/framework/core/
# - src/*.py → /root/WORKSPACE/ai/setups/framework/src/
```
...
1. **Deploy** - Copy all files to `/root/WORKSPACE/ai/setups/framework/`
